    ...
    "translations": {
      "he": {
        "consentModal": {
          ...
          "description": "מרכז החיפויים ליאור דיזיין משתמש בעוגיות כדי לשפר את החוויה שלך, לנתח שימוש באתר ולסייע במאמצי השיווק שלנו.",
    ...
    contactForm.addEventListener('submit', async function(e) {
        ...
        try {
            ...
            const response = await fetch('https://api.zappy5.com/api/email/contact-form', {
                ...
                body: JSON.stringify({
                    websiteId: '8a54ea9b-8f8d-44e8-a4a9-2af98c6fa32c',
                    name: data.name || '',
                    email: data.email || '',
